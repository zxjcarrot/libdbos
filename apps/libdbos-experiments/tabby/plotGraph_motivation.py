...
zipf = ["0", "0.9"]
#zipf = [0]
systems = ["tabby", 'vmcache']
labels = ["Tabby", 'vmcache']
    ...
    for ratio in ratios:
        for ff in zipf:
            ...
            for system in systems:
                ...
                print(thputs)
                offset = width * multiplier
                axes.plot(attr, thputs, marker=next(markers), markersize=MARKERSIZE, label=attr)
                multiplier += 1
...
#             plt.subplots_adjust(top=0.8)
            ...
            plt.savefig('graph/{}_ratio_{}_zipf_{}_{}_motivation'.format(t, ratio, ff, wtype) + '.pdf', bbox_inches='tight', pad_inches=0)
